...
# Why I love interactive mapping with Rshiny

Many thanks to this awesome [book](https://mastering-shiny.org/index.html)
--
...
Getting your science out there, people can use it.

Why R? 

Can use it to make CUSTOMISED apps without knowing HTML, CSS, JavaScript

Cons: requires app to be hosted on a server rather than directly on a web browser
---
# Who uses Rshiny?

show examples
Academics - teaching stats, communicating research, making it open
...
Providing a recipe for inputs to turn into outputs
Different from writing a normal script

This happens in the server function (every end-user sees the same UI) - creates new local environment independent of every other end-users server.
...
Frontend (what end-user sees), backend (what you code)
User interface (how it looks)
Server function (how it workds)
Reactive programming and reactive expressions
...
Deploying your app
Making it availalbe to anyone with a web browser
Share on a server

What is a server?

shinyapps.io 
Free but slow, plus subscription options
There are other servers out there too. 

[See here for more info](https://shiny.rstudio.com/articles/shiny-server.html)
---
Let's get started
