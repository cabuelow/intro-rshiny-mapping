...
subtitle: "*to engage end-users with research*"
...
# Our journey in Maps and Apps...

1. The basics of programming for interactivity: *Reactivity*

--

2. What are our options for mapping interactively in R?
--
...
--
### Open Science
  - Web apps are a great way to make our research open and transparent
  
--

### Shiny 
  - Nice and performative apps without HTML, javascript, CSS...
--
...
--
Also, many thanks to this awesome [book](https://mastering-shiny.org/index.html) for informing much  of this tutorial.
---
# App fundamentals
...
What is reactive programming?
  ...
  - Follow a recipe that we (the programmers) provide
...
Shiny provides a framework for reactive programming:
  ...
  - Server: follows the recipe to turn inputs into outputs

*hint*: if you have {shiny} installed, just type `shinyapp` in your R script to insert boilerplate shiny app code to get started quickly
...
If we're in a hurry, we can put our interactive `tmap` in a web app to share
...
What package should I use for interactive web maps?
...
Some say more fine-grained control with mapdeck

Recommend choosing based on needs, start with simplest, but if have large, complex app, go with Mapdeck
---
...
Use rmapshaper to simplify

More complicated apps, the 'cliff of complexity'
Check out this [book](https://engineering-shiny.org/successful-shiny-app.html)
- Modules
- Caching
-etc....
